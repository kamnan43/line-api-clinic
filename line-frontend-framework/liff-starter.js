...
function displayLiffData() {
    ...
    liff.getFriendship().then(data => {
        document.getElementById('isFriendship').textContent = data.friendFlag
    });
}
...
function registerButtonHandlers() {
    ...
    document.getElementById('shareMessageButton').addEventListener('click', function () {
        if (!liff.shareTargetPicker()) {
            ...
            liff.shareTargetPicker([{
                'type': 'text',
                'text': "You've successfully share a message! Hooray!"
            }]).then(function () {
                window.alert('Share window activate');
            }).catch(function (error) {
                window.alert('Error sending message: ' + error);
            });
        }
    ...
    // openLinkedOA call
    document.getElementById('openLinkedOA').addEventListener('click', function () {
        // window.location = '';
    });
...
function functionUnavailable() {
    alert('This button is unavailable, please update LINE app');
}
